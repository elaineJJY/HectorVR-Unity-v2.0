...
//
// Purpose: Handles Target position selection
// Modified:Jingyi
//
//=============================================================================
...
namespace Valve.VR.InteractionSystem
{
    ...
    {
        public SteamVR_Action_Boolean teleportAction = SteamVR_Input.GetAction<SteamVR_Action_Boolean>("InteractUI");
        public bool autoDrive;
        public Vector3 targetPosition;
		public GameObject TargetFlag;
    	public GameObject TargetFlagPrefab;
		...
		//-------------------------------------------------
		private static TargetLaser _instance;
		public static TargetLaser instance
		{
			get
			{
				if ( _instance == null )
				{
					_instance = GameObject.FindObjectOfType<TargetLaser>();
				}
		...
		private void TeleportPlayer()
		{
			...
			if(InteractionManagement.Instance.Robot_Locked){
				InteractionManagement.Instance.SetPlayerText("The Robot is locked",5,false);
			}
			else{
				targetPosition =  teleportPosition;
            	autoDrive = true;
            	InteractionManagement.Instance.SetPlayerText("Start Auto Driving",5,false);

				// crete a target flag
				GameObject.Destroy(TargetFlag);
                TargetFlag = GameObject.Instantiate(TargetFlagPrefab);
